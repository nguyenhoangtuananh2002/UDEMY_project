...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function searchByName(param){
        ...
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxShop",
            type: "get", //send it through get method
            data: {
                txt: txtSearch
            },
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorWhite(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxColorWhite",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorGray(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxColorGray",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorBlack(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxColorBlack",
            type: "get", //send it through get method
            data: {
    ...
    function searchByColorYellow(){
        $.ajax({
            url: "/Udemy_CLONE/searchAjaxColorYellow",
            type: "get", //send it through get method
            data: {
    ...
    function loadAmountCart(){
    	 $.ajax({
             url: "/Udemy_CLONE/loadAllAmountCart",
             type: "get", //send it through get method
             data: {
