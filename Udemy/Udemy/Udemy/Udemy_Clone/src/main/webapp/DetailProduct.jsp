              ...
              <table class="table table-sm table-borderless">
                <tbody>
                  <tr>
                    ...
                    <td class="pb-0">Select Duration</td>
                  </tr>
                  <tr>
                    <td class="pl-0">
                    <div class="mt-1">
                    ...
                    <td>
                      <div class="mt-1">
                        <div class="form-check form-check-inline pl-0">
                          <input type="radio" class="form-check-input" id="15-ngày" value="15-ngày" name="size" checked>
                          <label class="form-check-label small text-uppercase card-link-secondary"
                            for="15-ngày">15-ngày</label>
                        </div>
                        <div class="form-check form-check-inline pl-0">
                          <input type="radio" class="form-check-input" id="30-ngày" value="30-ngày" name="size">
                          <label class="form-check-label small text-uppercase card-link-secondary"
                            for="30-ngày">30-ngày</label>
                        </div>
                        <div class="form-check form-check-inline pl-0">
                          <input type="radio" class="form-check-input" id="full-course" value="full-course" name="size">
                          <label class="form-check-label small text-uppercase card-link-secondary"
                            for="full-course">full-course</label>
                        </div>
                      </div>
                    </td>
                  </tr>
        ...
        <div class="tab-content" id="advancedTabContent">
          ...
          <div class="tab-pane fade" id="info" role="tabpanel" aria-labelledby="info-tab">
            ...
            <table class="table table-striped table-bordered mt-3">
              <thead>
                <tr>
                  <th scope="row" class="w-150 dark-grey-text h6">Contact Us</th>
                  <td><em>doanjava123@gmail.com</em></td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <th scope="row" class="w-150 dark-grey-text h6"></th>
                  <td><em>11111111</em></td>
                </tr>
                <tr>
                  <th scope="row" class="w-150 dark-grey-text h6"></th>
                  <td><em>00000000</em></td>
                </tr>
              </tbody>
              <tbody>
            </table>
